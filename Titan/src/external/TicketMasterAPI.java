...
public class TicketMasterAPI implements ExternalAPI{
	...
	private static final String API_KEY = "A0hKRYJEa3vNj0aLaEO1BU8AXaY15Nwy";
	@Override
    public List<Item> search(double lat, double lon, String term) { // term is keyword
...
//		 tmApi.queryAPI(37.38, -122.08);
		...
		// Houston, TX
		tmApi.queryAPI(43.0879790, -89.4343450);// Madison
